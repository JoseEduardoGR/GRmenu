...
class GRmenu
  ...
  def self._normalize_font(f)
    f.each do |key, lines|
      ...
      f[key] = lines.map { |line| line.ljust(max_w) }.freeze
    end
    f.freeze
  end
  FONT_1 = _normalize_font({
    'A' => ["  ██████╗   ", " ██╔════██╗ ", " █████████║ ", " ██╔════██║ ", " ██║    ██║ ", " ╚═╝    ╚═╝ "],
    'B' => [" ██████╗   ", " ██╔═══██╗ ", " ██████╔╝  ", " ██╔═══██╗ ", " ██████╔╝  ", " ╚═════╝   "],
    'C' => ["  ██████╗  ", " ██╔════╝  ", " ██║       ", " ██║       ", " ╚██████╗  ", "  ╚═════╝  "],
    'D' => [" ██████╗   ", " ██╔══██╗  ", " ██║  ██║  ", " ██║  ██║  ", " ██████╔╝  ", " ╚═════╝   "],
  ...
  FONT_6 = _normalize_font({
    ...
    'V' => [" _____ ", "|  |  |", "|  |  |", " \\___/ ", "       "],
    'W' => [" _____ ", "|  |  |", "| | | |", "|_____|", "       "],
    'X' => [" _____ ", "|_   _|", "  |_|  ", " _| |_ ", "|_____|"],
    'Y' => [" _____ ", "|  |  |", " \\   / ", "  |_|  ", "       "],
    'Z' => [" _____ ", "|_   _|", "   / / ", "  / /_ ", "|_____|"],
    '0' => [" _____ ", "|     |", "|  |  |", "|_____|", "       "],
    '1' => ["  ___   ", " |_  |  ", "  _| |_ ", " |_____|", "        "],
    '2' => [" _____ ", "|_   _|", " _| |_ ", "|_____|", "       "],
    '3' => [" _____ ", "|_   _|", "  |_  |", " |____|", "       "],
    '4' => [" _____ ", "|  |  |", "|_   _|", "  |_|  ", "       "],
    '5' => [" _____ ", "|   __|", "|__   |", "|_____|", "       "],
    '6' => [" _____ ", "|   __|", "|  |  |", "|_____|", "       "],
